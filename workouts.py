...
recovery_run: dict[int, Workout] = {
    1: Workout([Segment(min(20), HR1)], name="Recocery run 1"),
    2: Workout([Segment(min(25), HR1)], name="Recocery run 2"),
    3: Workout([Segment(min(30), HR1)], name="Recocery run 3"),
    4: Workout([Segment(min(35), HR1)], name="Recocery run 4"),
    5: Workout([Segment(min(40), HR1)], name="Recocery run 5"),
    6: Workout([Segment(min(45), HR1)], name="Recocery run 6"),
    7: Workout([Segment(min(50), HR1)], name="Recocery run 7"),
    8: Workout([Segment(min(55), HR1)], name="Recocery run 8"),
    9: Workout([Segment(min(60), HR1)], name="Recocery run 9"),
}
